...
import { Search, Filter, Download, ArrowUpRight, ArrowDownLeft, Plus, Minus, ChevronLeft, ChevronRight } from 'lucide-react';
                  ...
                  {isLoading ? (
                    ...
                    data.transactions.map((transaction) => (
                      <TableRow key={transaction.id}>
                        ...
                        <TableCell className="text-muted-foreground">{formatCurrency(transaction.fee)}</TableCell>
                        <TableCell>
